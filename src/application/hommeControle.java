	...
	//table voiture sortee
	   ...
	   private Connection connection2;
		...
		private PreparedStatement pst2;
		 ...
		 Filtrage_Voiture  a=new Filtrage_Voiture();
	...
	{ 
	       	...
	       	int n=ct.getIndex();
				...
				}else
				{
						...
						if(action.get()==ButtonType.OK)
						{
							handler4=new DBHundler();
						connection4 = handler4.getConnection();
				        String SQL="DELETE  from reservation where id="+n;
				        pst4= connection4.prepareStatement(SQL);
						pst4.executeUpdate();
                    creatPage3();	
						}
...
public void creatPage4() {
	...
	tableau4.setTopAnchor(a.startt(), 10.0);
	tableau4.setLeftAnchor(a.startt(), 40.0);
	tableau4.setRightAnchor(a.startt(), 50.0);
	tableau4.setBottomAnchor(a.startt(), 10.0);
	tableau4.getChildren().add(a.startt());
...
public void choosecarAUDI() {
	...
	try {
		...
		setNode(AnchorpanechoosecarAUDI);
	} catch (IOException eee) {
		// TODO Auto-generated catch block
		eee.printStackTrace();
	}
...
public void choosecarMERCEDESS() {
	...
	try {
		AnchorpanechoosecarMERCEDESS = FXMLLoader.load(getClass().getResource("/application/carschoose.fxml"));
		setNode(AnchorpanechoosecarMERCEDESS);
	} catch (IOException eee) {
		// TODO Auto-generated catch block
		eee.printStackTrace();
	}
...
public void choosecarVW() {
	...
	public void creatPageVoiturssorte() {
		/*vscontrollere vsc=new vscontrollere();
		anchorpanehomee.getChildren().clear();
		anchorpanehomee.setTopAnchor(vsc.startt(), 10.0);
		anchorpanehomee.setLeftAnchor(vsc.startt(), 40.0);
		anchorpanehomee.setRightAnchor(vsc.startt(), 50.0);
		anchorpanehomee.setBottomAnchor(vsc.startt(), 10.0);
		anchorpanehomee.getChildren().add(vsc.startt());*/
		try {
	...
	//*******************************
	public void Filtragedesvoitures() {
		/*vscontrollere vsc=new vscontrollere();
		anchorpanehomee.getChildren().clear();
		anchorpanehomee.setTopAnchor(vsc.startt(), 10.0);
		anchorpanehomee.setLeftAnchor(vsc.startt(), 40.0);
...
public class hommeControle extends Application{
	...
	//button mes voitures
	public void creatPage() {
		Button bt=new Button("bbbbbbbbb");
		carstablecontrole ctc=new carstablecontrole();
		anchorpanehomee.getChildren().clear();
		anchorpanehomee.setTopAnchor(bt, null);
		anchorpanehomee.setTopAnchor(ctc.startt(), 10.0);
		anchorpanehomee.setLeftAnchor(ctc.startt(), 40.0);
		anchorpanehomee.setRightAnchor(ctc.startt(), 50.0);
		anchorpanehomee.setBottomAnchor(ctc.startt(), 10.0);
		anchorpanehomee.getChildren().add(ctc.startt());
		ctc.startt().setPadding(new Insets(15,20, 10,10));
	}
	// button commande
	public void creatPagecommande() {
		try {
			anchorpaneCommande = FXMLLoader.load(getClass().getResource("/application/Commande.fxml"));
			setNode(anchorpaneCommande);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
